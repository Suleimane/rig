...
@ManagedBean
public class GraficoAnualFibra implements Serializable {

	private static final long serialVersionUID = 4342083196472082231L;
	...
	private BarChartModel initBarModel() {
		...
		vendasVivoFibra.setLabel("fibra");
		
		for(String mes : DataUtil.listaDeMeses()){
			vendasVivoFibra.set(mes, 125);
		}
